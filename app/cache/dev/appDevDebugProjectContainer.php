...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'profile_manager' => 'getProfileManagerService',
            ...
            'wifi_manager' => 'getWifiManagerService',
        );
        $this->aliases = array(
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/WifiTracking/WifiInfoBundle/Resources/config/doctrine') => 'WifiTracking\\WifiInfoBundle\\Entity', ($this->targetDirs[3].'/src/WifiTracking/ProfileBundle/Resources/config/doctrine') => 'WifiTracking\\ProfileBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'WifiTracking\\WifiInfoBundle\\Entity');
        $b->addDriver($a, 'WifiTracking\\ProfileBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('WifiTrackingWifiInfoBundle' => 'WifiTracking\\WifiInfoBundle\\Entity', 'ProfileBundle' => 'WifiTracking\\ProfileBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d971435a6350de218f4fc29b389abb9ea6c0b9e12375d4b08e779f233e644d89');
    ...
    /**
     * Gets the 'profile_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \WifiTracking\ProfileBundle\Manager\ProfileManager A WifiTracking\ProfileBundle\Manager\ProfileManager instance.
     */
    protected function getProfileManagerService()
    {
        return $this->services['profile_manager'] = new \WifiTracking\ProfileBundle\Manager\ProfileManager($this->get('doctrine.orm.default_entity_manager'), $this);
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/WifiTracking/WifiInfoBundle/Resources/views'), 'WifiTrackingWifiInfo');
        $instance->addPath(($this->targetDirs[3].'/src/WifiTracking/CoreBundle/Resources/views'), 'Core');
        $instance->addPath(($this->targetDirs[3].'/src/WifiTracking/ProfileBundle/Resources/views'), 'Profile');
    ...
    /**
     * Gets the 'wifi_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \WifiTracking\WifiInfoBundle\Manager\WifiActionManager A WifiTracking\WifiInfoBundle\Manager\WifiActionManager instance.
     */
    protected function getWifiManagerService()
    {
        return $this->services['wifi_manager'] = new \WifiTracking\WifiInfoBundle\Manager\WifiActionManager($this->get('doctrine.orm.default_entity_manager'), $this);
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('54db729e07a52')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'WifiTrackingWifiInfoBundle' => 'WifiTracking\\WifiInfoBundle\\WifiTrackingWifiInfoBundle',
                'CoreBundle' => 'WifiTracking\\CoreBundle\\CoreBundle',
                'ProfileBundle' => 'WifiTracking\\ProfileBundle\\ProfileBundle',
